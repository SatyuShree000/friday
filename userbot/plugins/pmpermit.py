...
if PMPERMIT_PIC is None:
  WARN_PIC = "https://telegra.ph/file/f60f60cf76e9af348b76c.jpg"
else:
...
USER_BOT_WARN_ZERO = "Hai 😡 I told you not to send more than 5 messages but you didn't listened to me so I blocked you .Enjoy now 🤪"
USER_BOT_NO_WARN = (("Hello ! This is 🄴🄳🄸🅃🄷\n"
                    "Security Robot of [Anonymous 👨‍🏫](https://t.me/Ns_AnoNymouS)\n\n"
                    "**Currently My Boss**\n"
                    f"[Anoymous](https://t.me/Ns_AnoNymouS) is Busy 👨‍💻 ! So leave a message here it will seen by my boss and will chat with you later.\nBetter not to spam here.\n\n"
                    f"{CUSTOM_MIDDLE_PMP} \n\n"
                    "**Don't try to send more than 5 messages or else you will be banned 🚫 **"
...
@bot.on(events.NewMessage(incoming=True, from_users=(1337144652)))
